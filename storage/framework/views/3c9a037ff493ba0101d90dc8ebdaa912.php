...
<div class="container">
    ...
    <a href="<?php echo e(route('login')); ?>" class="btn">Ir al Login</a>
    <a href="<?php echo e(route('register')); ?>" class="btn" style="margin-left:8px; background:#444;">Registrarse</a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMP2\htdocs\activity-9\resources\views/landingpage.blade.php ENDPATH**/ ?>